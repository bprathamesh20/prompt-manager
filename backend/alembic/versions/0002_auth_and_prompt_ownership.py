"""Add auth users and prompt ownership.

Revision ID: 0002_auth_and_prompt_ownership
...
revision: str = "0002_auth_and_prompt_ownership"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("owner_id", "name", name="uq_prompts_owner_name"),
    )
